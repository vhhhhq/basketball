  ...
  return (
    <div className='container'>
        <div className='container-block'>
            <div className='content-block-bestsellers' >
                <p>Jerseys 1992 team usa</p>
            </div>
            <div className='title-block-start-bestsellers'>
                <p>
                    <span className='color-blue'>1992 </span> 
                    <span className='color-red'>team usa</span> 
                </p>
            </div>
            <div className='title-block-end-bestsellers'>
                <p>Authentic edition</p>
            </div>
            <div className="text-content-block-bestsellers">
                <p>
                    <p>Jerseys of the united sates man’s olympics basketball team,</p> 
                    <p>which represented the us of a in the 1992 summer olympics in barcelona.</p> 
                </p>
            </div>
